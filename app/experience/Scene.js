...
export default function Scene(props) {
  const { nodes, materials } = useGLTF('./models/brutalist_computers.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[-9.485, 0, 8.941]} rotation={[-Math.PI / 2, 0, -0.872]} scale={0.338}>
      ...
      <group scale={0.01}>
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Plane044_Concrete_Tiles_0.geometry}
          material={materials.Concrete_Tiles}
          position={[-7.997, 0.994, 119.397]}
...
useGLTF.preload('./models/brutalist_computers.glb')
